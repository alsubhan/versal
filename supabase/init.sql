...
-- Extracted on: Thu Nov 27 20:17:14 +04 2025
-- ==========================================
...
INSERT INTO "public"."system_settings" ("id", "setting_key", "setting_value", "setting_type", "description", "is_public", "created_by", "created_at", "updated_at") VALUES
	...
	('1bd4b70b-4f22-46ff-a265-7fc5d7ea300e', 'email_notifications_enabled', 'false', 'boolean', 'Enable email notifications', false, NULL, '2025-07-30 07:52:15.797261+00', '2025-11-27 15:48:37.165282+00'),
	('31c52908-be29-46ee-9eeb-9a670f82af5a', 'enable_signup', 'false', 'boolean', 'Enable user signup feature', true, NULL, '2025-07-30 08:47:52.083239+00', '2025-11-27 16:01:27.541903+00'),
...
-- Summary: Found data for 10 table(s):
--   categories: 7 row(s)
--   customers: 5 row(s)
--   locations: 3 row(s)
--   product_serials: 4 row(s)
--   products: 3 row(s)
--   roles: 3 row(s)
--   suppliers: 5 row(s)
--   system_settings: 53 row(s)
--   taxes: 3 row(s)
--   units: 6 row(s)
